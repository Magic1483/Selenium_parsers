...
url='https://www.delivery-club.ru/retail/magnit/catalog/19286?placeSlug=magnit_ljnqh'
...
# sleep(5)
wait.until(EC.visibility_of_element_located((By.XPATH,'//div[@class="DesktopAddressButton_root"]/button')))
